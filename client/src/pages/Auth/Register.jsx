...
export const Register = () => {
    ...
    const styles = {
        ...
        loginText: "text-mainText",
        loginLink: "text-highlight font-semibold hover:underline ml-1",
        ...
        <section className={styles.container}>
            <div className={styles.card}>
                ...
                <form className={styles.form} onSubmit={handleRegister}>
                    <h1 className="text-3xl font-semibold text-mainText font-sans">Register</h1>
